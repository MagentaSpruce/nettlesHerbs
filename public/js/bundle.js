          ...
          e.forEach(function(e) {
            ...
            (t.className = 'marker'),
              new mapboxgl.Marker({ element: t, anchor: 'bottom' })
                ...
                .addTo(o),
              new mapboxgl.Popup({ offset: 30, closeOnClick: !1 })
                .setLngLat(e.coordinates)
                .setHTML('<p>'.concat(e.description, '</p>'))
                .addTo(o),
                    ...
                    switch ((t.prev = t.next)) {
                      case 0:
                        return (
                          ...
                          (t.next = 4),
                          (0, e.default)(
                            '/api/v1/purchases/checkout-session/'.concat(r)
                          )
                        );
                      case 4:
                        return (
                          (o = t.sent),
                          (t.next = 7),
                          n.redirectToCheckout({ sessionId: o.data.session.id })
                        );
                      case 7:
                        t.next = 12;
                        break;
    ...
    Focm: [
      function(require, module, exports) {
        ...
        var e = require('./mapbox'),
          ...
          u = document.getElementById('buyBtn');
        if (o) {
          var j = JSON.parse(o.dataset.locations);
          (0, e.displayMap)(j);
        }
        u.addEventListener('click', function(e) {
          e.target.textContent = 'Processing...';
          var r = e.target.dataset.productId;
          (0, s.makePurchase)(r);
        });
        var i = document.querySelector('body').dataset.alert;
        i && (0, r.showAlert)('success', i, 10);
      },
      {
