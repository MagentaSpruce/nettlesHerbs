...
var tabsContent = document.querySelectorAll('.operations__content'); // DELEGATION
...
var slider1 = function slider1() {
  ...
  var dotContainer = document.querySelector('.dots'); // slider.style.transform = `scale(0.5) translateX(-120rem)`;
  // slider.style.overflow = 'visible';

  var curSlide = 0;
  var maxSlide = slides.length; //slides is a nodelist
  ...
  var goToSlide = function goToSlide(slide) {
    slides.forEach(function (s, i) {
      return s.style.transform = "translateX(".concat(150 * (i - slide), "%)");
    });
  };
