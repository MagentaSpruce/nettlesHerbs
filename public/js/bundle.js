      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)("/api/v1/purchases/checkout-session/".concat(productId));
