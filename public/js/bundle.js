...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWFnZW50YXNwcnVjZSIsImEiOiJja29sbDVpNTYxbmFxMndwbjZnaXN0OXdzIn0.fc63_3pVYyGH3Zl1eAU09A';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/magentaspruce/ckpzxgp6r2hpe18l738oxqybd',
    scrollZoom: false //   center: [-81.6557, 30.3322],
    //   zoom: 10
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30,
      closeOnClick: false
    }).setLngLat(loc.coordinates).setHTML("<p>".concat(loc.description, "</p>")).addTo(map); // Extend map bounds to include current location
...
var makePurchase = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51J6EUWLhSy5ppJbLZSsRtVXXwZ29dJMvnwL7Uf0MEefrAHdQVD8XXZW2FGvvShMJTVQ6HwAYOzCMPXUqncaK5dOI00ntqw76Sh');
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)("http://127.0.0.1:3000/api/v1/purchases/checkout-session/".concat(productId));

          case 4:
            session = _context.sent;
            console.log(session); // 2) Create checkout form + charge CC using Stripe
  ...
  return function makePurchase(_x) {
...
var purchaseBtn = document.getElementById('buyBtn'); // DELEGATION
